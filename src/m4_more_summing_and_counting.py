...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(4, 10, 0.32)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 4
    answer = count_cosines_from(10, 20, 0.55)
    ...
    # Test 5:
    expected = 6
    answer = count_cosines_from(4, 20, 0.56)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(2, 12, 0.88)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.92897  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.26988  # This is APPROXIMATELY the correct answer.
